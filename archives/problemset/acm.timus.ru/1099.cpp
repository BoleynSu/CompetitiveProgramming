...
/*
Package:
å›¾è®º.ä¸€èˆ¬å›¾çš„æœ€å¤§åŒ¹é…

Description:
å¸¦èŠ±æ ‘å®žçŽ°çš„ä¸€èˆ¬å›¾æœ€å¤§åŒ¹é…

Interface:
MAXV:{
éœ€è¦ä¸ºç‚¹åˆ†é…å¤šå°‘ç©ºé—´
Warning:
ç‚¹ä¸€å®šè¦ä»Ž0åˆ°V-1ï¼Œå³MAXVåº”è¯¥ç­‰äºŽæœ€å¤§ç‚¹æ•°
}
MAXE:{
éœ€è¦ä¸ºè¾¹åˆ†é…å¤šå°‘ç©ºé—´
Warning:
ä¸€æ¡è¾¹å¯¹åº”ä¸€æ¡æ­£å‘è¾¹å’Œä¸€æ¡åå‘è¾¹ï¼Œå³æ³¨æ„MAXEè¦ç­‰äºŽå®žé™…æœ€å¤§è¾¹æ•°*2
}
V:{
ç‚¹æ•°
}
add_edge:{
è¾“å…¥int u,v
add_edge(u,v) åŠ ä¸€æ¡uåˆ°vçš„è¾¹å’Œä¸€æ¡våˆ°uçš„è¾¹
}
build_graph:{
æž„å›¾
...
edmonds()=æœ€å¤§åŒ¹é…æ•°
é™„åŠ è¾“å‡º:
å¦‚æžœmatch[u]==NOT_NODEåˆ™uæ²¡æœ‰è¢«åŒ¹é…
å¦è€…uä¸Žmatch[u]åŒ¹é…
}
...
lecture05.pdf
http://www.cs.berkeley.edu/~karp/greatalgo/lecture05.pdf
lecture06.pdf
http://www.cs.berkeley.edu/~karp/greatalgo/lecture06.pdf
blossom5.pdf
http://www.cs.ucl.ac.uk/staff/V.Kolmogorov/papers/blossom5.pdf
Edmonds's matching algorithm - Wikipedia, the free encyclopedia.htm
