...
int main()
{
	...
	for (int i=0;i<hull.cnt;i++)
		cmin(s1,abs(((hull.P[hull.F[i].a]-hull.P[hull.F[i].b])*(hull.P[hull.F[i].c]-hull.P[hull.F[i].a])^(p-hull.P[hull.F[i].b]))/sqrt(((hull.P[hull.F[i].a]-hull.P[hull.F[i].b])*(hull.P[hull.F[i].c]-hull.P[hull.F[i].b]))^((hull.P[hull.F[i].a]-hull.P[hull.F[i].b])*(hull.P[hull.F[i].c]-hull.P[hull.F[i].b])))));
	...
	p=hull.gc();
	for (int i=0;i<hull.cnt;i++)
		cmin(s2,abs(((hull.P[hull.F[i].a]-hull.P[hull.F[i].b])*(hull.P[hull.F[i].c]-hull.P[hull.F[i].a])^(p-hull.P[hull.F[i].b]))/sqrt(((hull.P[hull.F[i].a]-hull.P[hull.F[i].b])*(hull.P[hull.F[i].c]-hull.P[hull.F[i].b]))^((hull.P[hull.F[i].a]-hull.P[hull.F[i].b])*(hull.P[hull.F[i].c]-hull.P[hull.F[i].b])))));
