...
int main()
{
    ...
    db R,H;
    whl(cin>>R>>H) pdb(4,2*pi*sqr(R)*H-8.0*(R*R*(R-sqrt(sqr(R)-sqr(min(R,H/2.0))))-1.0/3.0*(R*R*R-sqrt(sqr(R)-sqr(min(R,H/2.0)))*sqrt(sqr(R)-sqr(min(R,H/2.0)))*sqrt(sqr(R)-sqr(min(R,H/2.0))))+sqrt(sqr(R)-sqr(min(R,H/2.0)))*sqr(min(R,H/2.0)))),puts("");
}
